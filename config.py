...
API_ID = int(os.getenv("23247228"))
API_HASH = os.getenv("6d0f35cfd57a970a7e761a0c1d5d311f")
BOT_TOKEN = os.getenv("7866554017:AAGxLaaov40CpUW7ByMWX4u-gKOGmSN0oHY")
...
LOG_GROUP_ID = int(os.getenv("-1002538521187", None))
...
START_IMG_URL = os.getenv("START_IMG_URL", "https://graph.org/file/b9bfe333b6cd18d21a43f-473873409a4cf84d55.jpg")
PING_IMG_URL = os.getenv("PING_IMG_URL", "https://graph.org/file/b9bfe333b6cd18d21a43f-473873409a4cf84d55.jpg")
